...
correct_password = "rat123"

# Zeige die Eingabeaufforderung in roter Schrift
print(Fore.RED + "Type in the password:" + Style.RESET_ALL)
...
if user_input == correct_password:
    print(Fore.GREEN + "Correct Password" + Style.RESET_ALL)
else:
    print(Fore.RED + "False Passwort" + Style.RESET_ALL)
import os
import time
import shutil
...
def main():
    ...
    menu = """
__        ______  _____ ____    _____ ___   ___  _     
\ \      / /  _ \|  ___|  _ \  |_   _/ _ \ / _ \| |    
 \ \ /\ / /| | | | |_  | | | |   | || | | | | | | |    
  \ V  V / | |_| |  _| | |_| |   | || |_| | |_| | |___ 
   \_/\_/  |____/|_|   |____/    |_| \___/ \___/|_____|
                                             ║
                                             ║
                                             ║
      ╔══════════════════════════════════════════════════════════════════════════════════╗
      ║ WDFD TOOL | v1.0.5 | [0] > Support (discord)             [ - ] [ □ ] [ X ]  ║
      ║══════════════════════════════════════════════════════════════════════════════════║
      ║                                                                                  ║
